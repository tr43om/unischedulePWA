    ...
    <div className=" left-0 z-10 mt-auto hidden w-full  gap-4  rounded-lg rounded-t-none border-t-[1px]   border-base-100 border-opacity-50  bg-white px-6 py-3  dark:bg-neutral sm:max-w-lg md:flex ">
      <div className=" flex items-center gap-1">
        <div className="kbd kbd-sm ">
          <ArrowUpIcon className="h-2.5  text-gray-500" />
        </div>
        <div className="kbd kbd-sm">
          <ArrowDownIcon className="h-2.5  text-gray-500" />
        </div>
        <p className="text-[10px] text-gray-500">Навигация</p>
      </div>
      ...
      <div className="flex items-center gap-1">
        ...
        <p className="text-[10px] text-gray-500">Выбрать</p>
      </div>

      {pathname !== "/" && (
        <div className="flex items-center gap-1">
          <div className="kbd  text-xs text-[10px] text-gray-500">Esc</div>
          <p className="text-[10px] text-gray-500">Закрыть</p>
        </div>
      )}
    </div>
  );
